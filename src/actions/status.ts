...
export const setMaterialDialogStatus = (status: boolean): SetMaterialDialogStatus => ({
  type: types.SET_MATERIAL_DIALOG_STATUS,
  status
})

export const setPageSettingsDialogStatus = (status: boolean, choosenPageId: number | null): SetPageSettingsDialogStatus => ({
  type: types.SET_PAGE_SETTINGS_DIALOG_STATUS,
  status,
  choosenPageId
})

export const setMaterialCurrentValue = (value: number): SetMaterialCurrentValue => ({
  type: types.SET_MATERIAL_CURRENT_VALUE,
  value
})

export const setMaterialChoosenCom = (com: Com | null): SetMaterialChoosenCom => ({
  type: types.SET_MATERIAL_CHOOSEN_COM,
  com
})

export const setBasicDialogStatus = (status: boolean, basicDialogMessage: string): SetBasicDialogStatus => ({
