...
class TopBar extends React.Component<Props, State> {
  ...
  showPublishDialog = () => {
    this.props.setBasicDialogShowStatus(
      true,
      '请点击链接预览，调整浏览器至手机模式。'
    );
  };
  ...
  render() {
    ...
    const renderItem = (item: topBarItem, index: number) => {
      return (
        <div
          ...
          onClick={() => this.handleAddCom(item.type)}
        >
          {item.name}
    ...
    return (
      <>
        ...
        <div className={styles.functions}>{renderItems}</div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>请填写关于作品的设置</DialogContentText>
            <TextField
              autoFocus
              margin="dense"
              id="title"
