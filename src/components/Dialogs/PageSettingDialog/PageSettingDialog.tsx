...
class PageSettingDialog extends React.Component<Props, State> {
  ...
  handleConfirm = async () => {
    ...
    try {
      ...
      await asyncSetPageSettingsAndStyles(
        pageSettings,
        pageStyles,
        choosenPageId
      );
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>请填写页面相关设置</DialogContentText>
            <TextField
              autoFocus
              margin="dense"
              id="page-title"
            ...
            <div>
              {this.state.wechatShareIcon !== '' && (
                <img
                  src={this.state.wechatShareIcon}
...
const mapDispatchToProps = (
  ...
  return {
    ...
    asyncSetPageSettingsAndStyles: async (
      pageSettings: PageSettings,
      pageStyles: PageStyles,
      pageId: number
    ) => {
