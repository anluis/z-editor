...
export const qiniuUrl = 'http://qiniucdn.xingstation.com';
export const apiUrl = process.env.REACT_APP_STAGING
  ? apiUrlStaging
  : process.env.NODE_ENV === 'production'
  ? apiUrlProduction
  : apiUrlStaging;
export const wxApiUrl = process.env.REACT_APP_STAGING
  ? wxApiUrlStaging
  : process.env.NODE_ENV === 'production'
  ? wxApiUrlProduction
  : wxApiUrlStaging;
